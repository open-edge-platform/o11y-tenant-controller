...
GOEXTRAFLAGS  :=-trimpath -gcflags="all=-N -l" -ldflags="all=-s -w -X main.version=$(shell cat ./VERSION) -X google.golang.org/protobuf/reflect/protoregistry.conflictPolicy=warn"
